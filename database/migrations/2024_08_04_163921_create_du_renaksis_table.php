...
return new class extends Migration
{
    ...
    {
        Schema::create('du_renaksi', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('judul');
            $table->string('pdf')->nullable()->default('0');
            $table->string('excel')->nullable()->default('0');
    ...
    {
        Schema::dropIfExists('du_renaksi');
    }
};
