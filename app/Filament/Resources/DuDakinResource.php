...
use App\Filament\Resources\DuDakinResource\Pages;
use App\Filament\Resources\DuDakinResource\RelationManagers;
...
class DuDakinResource extends Resource
{
    protected static ?string $model = DuDakin::class;

    protected static ?string $navigationIcon = 'heroicon-o-arrow-trending-up';
    protected static ?string $navigationGroup = 'Data Dukung';
    protected static ?string $modelLabel = 'Data Kinerja';
    protected static ?string $pluralModelLabel = 'Data Kinerja';
        ...
        return $form
            ->schema([
                ...
                Forms\Components\Select::make('triwulan')
                    ...
                    ->validationMessages([
                        'unique' => 'Dakin anda pada triwulan itu sudah ada sebelumnya.',
                    ])
                    ->required(),
                Forms\Components\FileUpload::make('pdf')
                    ...
                    ->getUploadedFileNameForStorageUsing(fn (Get $get): string => dm_sub_bidang::find($get('sub_bidang_id'))->nama . '.pdf')
                    ->disk('public')
                ...
                Forms\Components\FileUpload::make('excel')
                    ...
                    ->getUploadedFileNameForStorageUsing(fn (Get $get): string => dm_sub_bidang::find($get('sub_bidang_id'))->nama . '.xlsx')
                    ->disk('public')
                    ->directory(fn (Get $get): string => 
                        'dakin/' . 
                        Tahun::find($get('tahun_id'))->nama . 
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\Action::make('Verifikasi')
                    ...
                    ->fillForm(fn (DuDakin $record): array => [
    ...
    {
        return [
            'index' => Pages\ManageDuDakins::route('/'),
        ];
    }
}
